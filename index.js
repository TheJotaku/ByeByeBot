...
// Lets try !!yes and !!no again - Set flags then put flas in switch. 
...
client.on('message',async message =>{
    ...
    switch (command){
        ...
        case 'bison':
          message.channel.send(messageUserID + " bye Dad! :smiling_face_with_3_hearts:");
          break;
      ...
      if(newMember.channel)
        {
         ...
         // ignores AFK Channels 
          ...
          // upon leaving and the conditional statement wont execute correcntly for more than one person in a voice channel. 
          const voiceCount = voiceChannelCount + 1; 
        if (canSpeak === true && voiceCount > 1 ){
